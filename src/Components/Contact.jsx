...
function Contact() {
  return (
    <div className="min-h-screen bg-slate-200 dark:bg-black text-black dark:text-white text-center" id='Contact'>
      <motion.h1 
      initial = {{ opacity:0 }}
      whileInView = {{ opacity:1 }}
      transition = {{ duration:1, delay:0 }}
      className="text-4xl lg:text-6xl pt-24"><span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">Contact Me</span></motion.h1>
      <motion.p 
      initial = {{ opacity:0 }}
      whileInView = {{ opacity:1 }}
      transition = {{ duration:1, delay:0.3 }}
      className=" text-sm sm:text-lg mt-6 px-10">I love to collaborate with people. Contact me for collaborations or queries</motion.p>
      <motion.div 
      initial = {{ opacity:0 }}
      whileInView = {{ opacity:1 }}
      transition = {{ duration:1, delay:0.5 }}
      className="w-full py-4 flex items-center justify-center gap-4 flex-wrap mt-10 lg:mt-14">
        <a href='#' className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-black dark:bg-white group transition-all duration-300">
        <svg className="relative z-10 fill-gray-100 dark:fill-gray-900 transition-all duration-300 group-hover:fill-black dark:group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
          <path
        ...
        <a href='#' className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-black dark:bg-white group transition-all duration-500">
        <svg className="fill-gray-100 dark:fill-gray-900 relative z-10 transition-all duration-500 group-hover:fill-black dark:group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 51 51" fill="none">
        <path
        ...
        <a href='#' className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-black dark:bg-white group transition-all duration-300">
        <svg className="fill-white dark:fill-black z-10 transition-all duration-300 group-hover:fill-black dark:group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
        <path
        ...
        <a href='#' className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full bg-black dark:bg-white group transition-all duration-300">
        <svg className="fill-gray-100 dark:fill-gray-900 relative z-10 transition-all duration group-hover:fill-black-dark:300 group-hover:fill-white"  xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
        ...
        <a href='#' className="w-10 h-10 flex relative overflow-hidden items-center justify-center rounded-full bg-black dark:bg-white group transition-all duration-500">
        <svg className="fill-gray-100 dark:fill-gray-900 relative z-10 group-hover:fill-black dark:group-hover:fill-white transition-all duration-300 " 
      ...
      <h3 className="mt-8 lg:mt-14 text-sm lg:text-xl">Or send me a message, I will get back to you</h3>
      <div className="text-left px-14 mt-5 lg:mt-10">
        <form className="max-w-md mx-auto">
            <div className="relative z-0 w-full mb-5 group">
                ...
                <label for="Name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-purple-600 peer-focus:dark:text-purple-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name</label>
            </div>
            <div className="relative z-0 w-full mb-5 group">
            ...
            <div className="relative z-0 w-full mb-5 group">
                <textarea name="Message" id="Message" rows="4" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-500 focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder=" " required></textarea>
            ...
            <a href='#' type="submit" className="text-white bg-gradient-to-r from-cyan-600 to-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 mt-5 text-center transition-all duration-300">Submit</a>
        </form>
